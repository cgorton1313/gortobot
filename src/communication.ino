...
static void useWifi() {
        wifiSS.begin(wifiBaud);
        wifiSS.print(logSentence);
        Serial.print(F("Sent to wifi: "));
        Serial.println(logSentence);
        wifiSS.end();
}
